      ...
      <div className="DownloadPage">
        <div className="DownloadPage_Content">
          <p>
            ...
            healthcare system. Direct care providers can see, from within the
            system, where dangers lie. As witnesses on the front lines, if we
            can report our first hand knowledge, we can contribute to a fuller
            ...
            displayed on a dashboard, which includes a map of the U.S. We do not
            ask for any personally identifiable data.
            <br /> <br />
            ...
            Nightingale. Her research and visual display of data revealed
            patterns in causes of death among soldiers in the Crimean war,
            lighting the way for rational policy reforms and dramatically
        ...
        <div className="DownloadPage_Content_Bottom">
          ...
          <div>
            ...
            <p>
              ...
              project. We're an independent collaboration of voltuneer
              developers, nurses, physicians, attorneys, writters, designers,
              and journalists from the Code for America Brigade community. ©2020
            </p>
          </div>
        </div>
      </div>
